...
package com.erj.practice.wsimport.generated;
 ...
 * generated in the com.erj.practice.wsimport.generated package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetTeamsResponse_QNAME = new QName("http://service.practice.erj.com/", "getTeamsResponse");
    private final static QName _GetTeam_QNAME = new QName("http://service.practice.erj.com/", "getTeam");
    private final static QName _GetTeams_QNAME = new QName("http://service.practice.erj.com/", "getTeams");
    private final static QName _GetTeamResponse_QNAME = new QName("http://service.practice.erj.com/", "getTeamResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.erj.practice.wsimport.generated
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.practice.erj.com/", name = "getTeamsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.practice.erj.com/", name = "getTeam")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.practice.erj.com/", name = "getTeams")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.practice.erj.com/", name = "getTeamResponse")
